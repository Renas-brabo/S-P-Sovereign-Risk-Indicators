...
st.set_page_config(page_title="S&P Sovereign Risk Indicators Data", layout="wide")
...
def main():
    st.title("📊 S&P Sovereign Risk Indicators Data")
    st.caption("Dados públicos da base da agência S&P")
